...
const GAS_ESTIMATE_DEVIATION_PERCENT: {
  ...
  [ChainId.BLAST]: 34,
  [ExtendedChainId.CHILIZ]: 30, // @warning: this is assumption about chiliz chain
};
...
describe('quote for other networks', () => {
  const TEST_ERC20_1: { [chainId in ChainIdWithChiliz]: () => Token } = {
    ...
    [ExtendedChainId.CHILIZ]: () => USDC_ON(ExtendedChainId.CHILIZ),
  };
  const TEST_ERC20_2: { [chainId in ChainIdWithChiliz]: () => Token } = {
    ...
    [ExtendedChainId.CHILIZ]: () => DAI_ON(ExtendedChainId.CHILIZ),
  };
